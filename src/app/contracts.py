...
class MemoryService(Protocol):
    ...
    def delete(self, entry_id: str) -> Any | None: ...
    def update_text(self, entry_id: str, new_text: str) -> Any | None: ...
    def toggle_pin(self, entry_id: str) -> Any | None: ...
    def export_by_type(self, memory_type: str) -> str: ...
    def export_by_scope(self, scope: str) -> str: ...
    def clear_by_type(self, memory_type: str) -> int: ...
    def clear_by_scope(self, scope: str) -> int: ...
    def audit_log(self) -> Sequence[Any]: ...
